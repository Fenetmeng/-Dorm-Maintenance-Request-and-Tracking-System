# -Dorm-Maintenance-Request-and-Tracking-System
 ...
 This project is a dorm maintenance management system that allows users to report maintenance issues and track their status. The system includes authentication, role-based authorization, and two main business features: maintenance requests and assignment management. It uses a layered architecture and uses a REST API for communication between frontend and backend.
